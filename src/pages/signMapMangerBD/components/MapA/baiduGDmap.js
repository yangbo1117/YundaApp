...
import markerr from '../../../../asset/images/orange.png'
...
class Baidu extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            ysdlng:this.props.lnglat.split("，")[0], //保存原始点经纬度
            ysdlat:this.props.lnglat.split("，")[1],
            value:this.props.address,              //原始点地址
            lng:this.props.lnglat.split("，")[0],  //原始点经度
            lat:this.props.lnglat.split("，")[1], //原始点纬度
            branchId:this.props.branchId,
            dealmanId:this.props.dealmanId,
            signTime:this.props.signTime,
            nowMailNo:this.props.nowMailNo,
...
fath(){
    ...
    gaode = (keywords) => {
       ...
       componentDidMount(){
        ...
        var myIcon = new BMap.Icon(markerr, new BMap.Size(40,40),{ 
                    // offset: new BMap.Size(12, 35),// 图标中央下端的尖角位置。
