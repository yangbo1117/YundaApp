...
moment.locale('zh-cn');
class CorrectResultQuery extends React.Component {
        constructor(props){
            super(props)
            this.state={
                results:[], //查询结果
                formatAddress:'', // 标准化地址
                updateTimeStart:'', // 开始日期
                updateTimeEnd:'', // 结束日期
        ...
        async getTableList(params,pagination){
            let url = 'base/deliveryAddressCorrectList'
            let data = {
        ...
        async getTotal(params,pagination){
            let url = 'base/deliveryAddressCorrectCount'
            let data = {
                formatAddress:params.formatAddress,
                updateTimeStart:params.updateTimeStart,
                updateTimeEnd:params.updateTimeEnd,            
        ...
        return (
            <div>
                <div id="correctQuery" style={{display:this.state.tableShow===true?'block':'none'}}>
...
export default CorrectResultQuery
